...
from kuka_const import URDF_PATH

class Kuka:

  def __init__(self, urdfRootPath=URDF_PATH, timeStep=0.01):#urdfRootPath=pybullet_data.getDataPath(), timeStep=0.01):
  ...
  def applyAction(self, motorCommands):
    ...
    if (self.useInverseKinematics):
      ...
      #print("jointPoses")
      print(len(jointPoses), self.numJoints)
