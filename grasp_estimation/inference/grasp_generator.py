...
class GraspGenerator:
    ...
    def generate(self):
        ...
        pos_z = self.camera.left_intrinsics[0][0] / depth[grasps[0].center[0], grasps[0].center[1]] - 0.04
        pos_x = np.multiply(grasps[0].center[1] - self.camera.left_intrinsics[0][2],
                            pos_z / self.camera.left_intrinsics[0][0])
        pos_y = np.multiply(grasps[0].center[0] - self.camera.left_intrinsics[1][2],
